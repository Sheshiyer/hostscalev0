...
This is the canonical project entry point for the `hostscalev0`
...
- Registry WorkObject: `sapling:hostscale` (`HostScale`, kind: sapling)
- GitHub: `Sheshiyer/hostscalev0` (identity_status: pending-teamforge-verification)
...
`npm run build` is the current deterministic verification
command.
